...
#PRIMEIRO CRIAR AS TABELAS QUE NÃO TEM CHAVE ESTRANGEIRA

#Criando uma tabela que armazenará os dados dos LOGIN's.
...
#Criando uma tabela que armazenará os dados de todos os ENDEREÇOS.
...
#Criando uma tabela à parte que armazenará o arquivo referente ao questionário preenchido pela EMPRESA.
...
#Criando uma tabela para armazenar os dados dos FUNCIONÁRIOS responsáveis por administrar os PROJETOS, Aprovando OU Reprovando eles. Recebe os dados do LOGIN correspondente.
...
#Criando uma tabela para armazenar os dados das EMPRESAS que se cadastraram para dar entrada em algum PROJETO.
...
#Criando uma tabela para armazenar os dados de recuperação de senha de qualquer usuário do sistema para alterar a senha.
...
#Criando uma tabela para armazenar os dados dos USUÁRIOS que irão se cadastrar para se beneficiar em algum PROJETO.
...
#Criando uma tabela para armazenar os dados do SUPORTE da EMPRESA, como o texto enviado por um USUÁRIO. Recebe os dados do USUÁRIOS que acionou o suporte.
...
#Criando uma tabela para armazenar os dados de todos os PROJETOS, Recebe os dados da EMPRESA responsável pelo projeto e o arquivo da tabela FINANCEIRO.
...
#Criando uma tabela para armazenar os dados do status de cada projeto em função do tempo, armazenando as datas em que houve alteração no status do projeto, bem como o funcionário que fez a alteração. Para isso, essa tabela recebe os dados da tabela PROJETOS e FUNCIONARIOS.
...
#Tabela associativa resultante da ligação das tabelas PROJETOS e USUÁRIOS. Armazena os usuários inscritos em cada projeto.
...
#Inserindo dados na tabela RECUPERAR_SENHA
...
#Inserindo dados na tabela FALE_CONOSCO (suporte)
...
#Inserindo dados na tabela HISTORICO_ACOMPANHAMENTO
...
#Inserindo dados na tabela referente à entidade associativa USUARIOS_PROJETOS
